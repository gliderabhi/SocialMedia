...
public class FriendsListActivity extends AppCompatActivity {
    ...
    private void showUserList(){
        mFriendListAdapter = new FirebaseListAdapter<StudentDetails>(this, StudentDetails.class, R.layout.friend_item, mUserDatabaseReference) {
            @Override
            protected void populateView(final View view, StudentDetails user, final int position) {
                ...
                ((TextView)view.findViewById(R.id.messageTextView)).setText(user.getFirstName());
